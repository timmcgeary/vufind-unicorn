        ...
        if ($patron = $this->catalogLogin()) {
            ...
            if (!PEAR::isError($result)) {
                if (count($result)) {
                    ...
                    //CHANGED TO SIRSI-IZE VUFIND
                    $dg->addColumn(new Structures_DataGrid_Column(translate('Title'), 'id', 'id', null, null, 'printLink'));
                    $dg->addColumn(new Structures_DataGrid_Column(translate('Reason'), 'reason', 'reason'));
                    $dg->addColumn(new Structures_DataGrid_Column(translate('Billed Amt'), 'fine', 'fine', null, null, 'formatNumber'));
                    $dg->addColumn(new Structures_DataGrid_Column(translate('Balance'), 'balance', 'balance', null, null, 'formatNumber'));
                    $dg->addColumn(new Structures_DataGrid_Column(translate('Bill Date'), 'billdate', 'billdate'));
